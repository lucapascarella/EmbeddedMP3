 ...
 */
#include "../FatFS/ff.h"                   /* include tff.h for Tiny-FatFs */
...
#define ini_openrewrite(filename,file)  (f_open((file), (filename), FA_READ | FA_WRITE | FA_OPEN_ALWAYS) == FR_OK) // Correct setting #define FF_USE_STRFUNC	1
